...
\begin{figure}[!tbh]
\centering        
   \subfloat[Overview of IDS based graph coloring] {\includegraphics[width=0.24\textwidth]{naive.jpg}}
   \subfloat[Overview of communication free graph coloring] {\includegraphics[width=0.24\textwidth]{comfree.jpg}}
   \subfloat[data structure of CF graph coloring ] {\includegraphics[width=0.24\textwidth]{confre.jpg}}
   \subfloat[detail about CF load balancing] {\includegraphics[width=0.24\textwidth]{scanlbswir.jpg}}
   \caption{ }
   \label{fig:fig1}
\end{figure}
